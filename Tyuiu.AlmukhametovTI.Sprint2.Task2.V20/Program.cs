...
using Tyuiu.AlmukhametovTI.Sprint2.Task2.V20.Lib;

namespace Tyuiu.AlmukhametovTI.Sprint2.Task2.V20
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (res)
            {
                Console.WriteLine("Tочка находится в заштрихованной области");
            }
            else
            {
